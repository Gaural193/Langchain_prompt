...
#this will give us a error message wjen we there is extra or less parameter in above input_variable
)

# now here we are save the above template in a json formate and the json file will create
